...
;(()=>{
  ...
  function addCommunitySection(){
    ...
    const section=document.createElement('section');section.id='community';section.className='community-section';section.innerHTML='<div class="wrap community-inner"><img class="community-logo" src="/world-tv-logo.png" alt="WORLD TV"><div class="section-head"><h2>WORLD TV Telegram Support</h2><p>Get customer support, subscription help and WORLD TV updates. Scan the code or tap the button to message us.</p></div><div class="community-grid" style="grid-template-columns:minmax(0,620px);justify-content:center"><article class="community-card"><img src="/assets/telegram-qr.svg" alt="Scan to message WORLD TV on Telegram"><div><h3>Telegram</h3><div class="community-handle">@MYWORLDTVLIVE</div><p>Message WORLD TV on Telegram for subscriptions, setup help and customer support.</p><a class="community-button telegram-button" href="https://t.me/MYWORLDTVLIVE" target="_blank" rel="noopener">✈ Message us on Telegram</a></div></article></div><div class="community-note">WORLD TV customer support • Scan or tap to connect</div></div>';

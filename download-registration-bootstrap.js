...
function textToHtml(text){
 ...
 return `<!doctype html><html><body style="margin:0;background:#fffaf0;font-family:Arial,sans-serif;color:#17130a"><div style="max-width:680px;margin:0 auto;padding:26px 18px"><div style="background:#ffffff;border:1px solid #eadfc8;border-radius:18px;padding:28px;box-shadow:0 8px 28px rgba(79,55,0,.08)"><div style="text-align:center;margin-bottom:22px"><img src="${LOGO_URL}" alt="WORLD TV" width="150" style="display:inline-block;max-width:150px;height:auto;border:0"><div style="font-size:12px;color:#8a6b1d;margin-top:6px">Watch Anywhere. Enjoy More.</div></div><p style="font-size:16px;line-height:1.65">${body}</p><div style="background:linear-gradient(135deg,#fff4c7,#ffe18a);border:1px solid #e9c65e;border-radius:16px;padding:22px;text-align:center;margin:24px 0"><div style="font-size:14px;font-weight:800;color:#765300">1-YEAR WORLD TV SUBSCRIPTION</div><div style="font-size:42px;font-weight:900;color:#17130a;margin:4px 0">US$23</div><div style="font-size:14px;color:#5f5849;margin-bottom:16px">Debit/Credit Card • Paystack • Mobile Money</div><a href="${BASE}/subscribe.html" style="display:inline-block;background:#17130a;color:#fff;text-decoration:none;font-weight:800;padding:14px 26px;border-radius:11px">Subscribe Now</a></div><div style="margin-top:28px;background:#f7fbff;border:1px solid #d7e8f6;border-radius:14px;padding:18px;text-align:center"><div style="font-size:22px;font-weight:800;margin-bottom:6px">WORLD TV Telegram Support</div><div style="font-size:14px;color:#54606d;margin-bottom:14px">@${TELEGRAM_HANDLE}</div><a href="${TELEGRAM_URL}" style="display:inline-block;background:#229ED9;color:#fff;text-decoration:none;font-weight:700;padding:12px 18px;border-radius:10px">✈️ Message us on Telegram</a></div><div style="text-align:center;margin-top:18px"><a href="${BASE}/products.html" style="display:inline-block;background:#17130a;color:#fff;text-decoration:none;font-weight:700;padding:12px 20px;border-radius:10px;margin:4px">View WORLD TV Box</a></div></div></div></body></html>`;
}

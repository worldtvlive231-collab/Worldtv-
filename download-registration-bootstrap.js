...
const WHATSAPP_NUMBER='15309040310';
...
function welcomeMessage(name,marketing){
 const first=`Hi ${name||'there'},\n\nThank you for registering and downloading WORLD TV! 🎉\n\nInstall and open the app, then log in with the same email and password you registered with. Enjoy your 3-day free trial — no credit card required. Explore live TV, movies, series, kids & anime, and live sports on supported Android devices.\n\nYEARLY SUBSCRIPTION\nContinue watching for only US$23 for 1 full year.\n\nPAYMENT METHODS\n• PayPal — pay the US$23 worldwide price directly.\n• Debit or credit card — pay securely worldwide through PayPal guest checkout.\n• Paystack — pay the current Ghana-cedi equivalent using Mobile Money, Visa or Mastercard.\n\nWhen your trial ends, subscribe from your official WORLD TV account to continue watching.`;
 const links=`\n\nSUBSCRIBE NOW: ${BASE}/subscribe.html\nNeed help? Visit ${BASE}/download.html\nWORLD TV Box: ${BASE}/products.html`;
...
function textToHtml(text){
 ...
 return `<!doctype html><html><body style="margin:0;background:#fffaf0;font-family:Arial,sans-serif;color:#17130a"><div style="max-width:680px;margin:0 auto;padding:26px 18px"><div style="background:#ffffff;border:1px solid #eadfc8;border-radius:18px;padding:28px;box-shadow:0 8px 28px rgba(79,55,0,.08)"><div style="text-align:center;margin-bottom:22px"><img src="${LOGO_URL}" alt="WORLD TV" width="150" style="display:inline-block;max-width:150px;height:auto;border:0"><div style="font-size:12px;color:#8a6b1d;margin-top:6px">Watch Anywhere. Enjoy More.</div></div><p style="font-size:16px;line-height:1.65">${body}</p><div style="background:linear-gradient(135deg,#fff4c7,#ffe18a);border:1px solid #e9c65e;border-radius:16px;padding:22px;text-align:center;margin:24px 0"><div style="font-size:14px;font-weight:800;color:#765300">1-YEAR WORLD TV SUBSCRIPTION</div><div style="font-size:42px;font-weight:900;color:#17130a;margin:4px 0">US$23</div><div style="font-size:14px;color:#5f5849;margin-bottom:16px">PayPal • Debit/Credit Card • Paystack • Mobile Money</div><a href="${BASE}/subscribe.html" style="display:inline-block;background:#17130a;color:#fff;text-decoration:none;font-weight:800;padding:14px 26px;border-radius:11px">Subscribe Now</a></div><div style="margin-top:28px"><div style="font-size:20px;font-weight:800;text-align:center;margin-bottom:14px;color:#17130a">Join the WORLD TV Community</div><div style="display:table;width:100%;table-layout:fixed;border-spacing:8px"><div style="display:table-cell;vertical-align:top;background:#f7fbff;border:1px solid #d7e8f6;border-radius:14px;padding:18px;text-align:center"><div style="font-size:22px;font-weight:800;margin-bottom:6px">Telegram</div><div style="font-size:14px;color:#54606d;margin-bottom:14px">@${TELEGRAM_HANDLE}</div><a href="${TELEGRAM_URL}" style="display:inline-block;background:#229ED9;color:#fff;text-decoration:none;font-weight:700;padding:12px 18px;border-radius:10px">✈️ Join on Telegram</a></div><div style="display:table-cell;vertical-align:top;background:#f6fff8;border:1px solid #d5efdc;border-radius:14px;padding:18px;text-align:center"><div style="font-size:22px;font-weight:800;margin-bottom:6px">WhatsApp</div><div style="font-size:14px;color:#54606d;margin-bottom:14px">Customer support</div><a href="${WHATSAPP_URL}" style="display:inline-block;background:#25D366;color:#fff;text-decoration:none;font-weight:700;padding:12px 18px;border-radius:10px">💬 Chat on WhatsApp</a></div></div></div><div style="text-align:center;margin-top:18px"><a href="${BASE}/products.html" style="display:inline-block;background:#17130a;color:#fff;text-decoration:none;font-weight:700;padding:12px 20px;border-radius:10px;margin:4px">View WORLD TV Box</a></div></div></div></body></html>`;
}
...
function registerLead(req,res){
 try{
  ...
  if(!queueId && !lead.welcome_sent_at){
   try{
    queueId=queueEmail(customer.id,email,'Thank you for downloading WORLD TV — enjoy your 3-day free trial',welcomeMessage(name,marketing));
 ...
 try{
  ...
  for(const r of rows){
   ...
   if(r.followup_type==='trial_day_1'){
    ...
    message=`Hi ${r.name},\n\nWe hope you are enjoying your WORLD TV 3-day free trial. Continue watching for only US$23 for 1 full year.\n\nPay with PayPal, debit/credit card worldwide, or Paystack using Mobile Money, Visa or Mastercard.\n\nSubscribe now: ${BASE}/subscribe.html\nJoin Telegram: ${TELEGRAM_URL}\nChat on WhatsApp: ${WHATSAPP_URL}\nWORLD TV Box: ${BASE}/products.html`;
   }else{
    subject='Keep watching WORLD TV after your trial';
    message=`Hi ${r.name},\n\nThank you for trying WORLD TV. Subscribe for only US$23 for 1 full year to continue watching.\n\nPayment methods: PayPal, debit/credit card worldwide, or Paystack with Mobile Money, Visa or Mastercard.\n\nSubscribe now: ${BASE}/subscribe.html\nJoin Telegram: ${TELEGRAM_URL}\nChat on WhatsApp: ${WHATSAPP_URL}\nWORLD TV Box: ${BASE}/products.html`;
   }
